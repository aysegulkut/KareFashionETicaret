        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
                <div class="col-md-1 col-sm-1 col-xs-1"></div>
                  <div class="col-md-9 col-sm-9 col-xs-9"><!-- InstanceBeginEditable name="ortaaa" --><h1 align="center"><b>Ürün Kayıt</h1>
<p><br>
  </p>

<p>&nbsp;</p>

<form method="POST" name="urunekleform" action="urunekle.php" enctype="multipart/form-data" >
  <div class="input-group input-group">
  <span class="input-group-addon" id="sizing-addon1">Adı</span>
  <input type="text" class="form-control" name="urunad" value=""  placeholder="Adı" aria-describedby="sizing-addon1" required>
</div>

<div class="input-group">
  <span class="input-group-addon" id="sizing-addon1">Özellikleri</span>
  <input type="text" class="form-control" enctype="multipart/form-data" name="urunozellik" value="" placeholder="Özellikleri" aria-describedby="sizing-addon1" required>
</div>

<div class="input-group input-group-sm">
  <span class="input-group-addon" id="sizing-addon1">Fiyat</span>
  <input type="text" class="form-control" name="urunfiyat"  placeholder="Fiyat" value="" aria-describedby="sizing-addon1" required>
</div>
<div>
  Fotoğraf 1: <input type="file" class="form-control-file border" name="urunfoto1"  required>
</div>

<div>
  Fotoğraf 2:<input type="file" class="form-control-file border" name="urunfoto2" required>
 </div>
 
 <div>
  Fotoğraf 3:<input type="file" class="form-control-file border" name="urunfoto3" required>
 </div>


<div align="right">
<input type="submit" value="Kaydet" class="btn btn-primary"></div>

  <input type="hidden" name="MM_insert" value="urunekleform">
</form>
