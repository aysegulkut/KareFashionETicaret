      ...
      <table width="70" border="0" cellpadding="20" >        
          <?php
            ...
            <div class="card" style="width:200px"> 
             <form action="urunsil.php" method="post" name="urunsilform" >
          
            <div class="row">
  <div class="column">
    <img src="<?php echo $yaz["urun_foto1"]; ?>" style="width:450%" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <div align="center"><img src="<?php echo $yaz["urun_foto1"]; ?>" style="width:40%"></div>
    </div>

    <div class="mySlides">
      <div class="numbertext">2 / 3</div>
      <div align="center"><img src="<?php echo $yaz["urun_foto2"]; ?>" style="width:40%"></div>
    </div>

    <div class="mySlides">
      <div class="numbertext">3 / 3</div>
      <div align="center"><img src="<?php echo $yaz["urun_foto3"]; ?>" style="width:40%"></div>
    </div>
    ...
    <a class="next" onclick="plusSlides(1)">&#10095;</a>
             ...
             <h4 class="card-title"><?php echo $yaz["urun_ad"]; ?></h4>
             <div class="card-body"><?php echo $yaz["urun_ozellik"]; ?>
             <p class="card-text"><?php echo $yaz["urun_fiyat"]; echo " ₺";?>					             </p>
             <a href='urunsil.php?id=<?php echo $yaz["urun_id"]; ?>'><button name="silbuton" type="button" value="Sil" class="btn btn-primary">Sil</button></a>
             </form>
             </div>
            <?php ++$i;if($i%4==0){
				 echo "</tr>";echo " </td>";
