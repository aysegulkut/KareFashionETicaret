        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
                <div class="col-md-1 col-sm-1 col-xs-1"></div>
                  <div class="col-md-9 col-sm-9 col-xs-9"><!-- InstanceBeginEditable name="ortaaa" --><form action="bilgilerimiguncelle.php" method="post">
  <table width="328" border="0">
  <tr>
    <td height="45">Kullanıcı Adı:</td>
    <td><input type="text" name="kullaniciAdi" value="<?php echo $_SESSION['kullaniciAdi'];?>"></td>
  </tr>
  <tr>
    <td height="45">Şifre:</td>
    <td><input type="password" name="sifre"></td>
  </tr>
  <tr>
    <td height="45">Şifre Tekrar:</td>
