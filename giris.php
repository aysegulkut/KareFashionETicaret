...
<body>
  ...
  <a href="uyeolform.php"><button type="button" name="uyeol" style="width:auto;" class="btn btn-dark">Üye Ol</button></a><!-- InstanceEndEditable -->
    </div>
    </div><!-- row-->
    </div><!--container-->
<!-- InstanceBeginEditable name="urunler" -->
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
 <a class="navbar-brand" href="girisyapilmamisindex.php">Anasayfa</a>
...
<div class="col-md-4 col-lg-4 col-sm-4"></div>
 <div class="col-md-4 col-lg-4 col-sm-4" align="center"><br>
 <form action="musterigiris.php" method="post">
  <div class="form-group">
    <label for="email">E-Mail</label>
    <input type="email" class="form-control" placeholder="Mail Adresinizi giriniz." id="email" name="mail">
  </div>
  <div class="form-group">
    <label for="pwd">Şifre</label>
    <input type="password" class="form-control" placeholder="Şifrenizi Giriniz." id="pwd" name="sifre">
  </div>
