...
<div class="container">
<div class="row">
 <!-- InstanceBeginEditable name="head" --><div class="col-lg-2 col-sm-2 col-md-2 col-xl-2"></div>
 <div class="col-lg-8 col-sm-8 col-md-8 col-xl-8">
 <form action="uyeol.php" method="post" onsubmit="return kontrol(this);" name="uyeol">
  ...
  <tr>
    <td>Ad</td>
    <td><input placeholder="Adınız" name="ad" class="form-control" type="text" required minlength="3"></td>
  </tr>
  <tr>
    <td>Soyad</td>
    <td><input placeholder="Soyadınız" name="soyad" class="form-control" type="text" required minlength="2" ></td>
  </tr>
  <tr>
    <td>Cep Telefonu</td>
    <td><input placeholder="0 kullanarak giriniz" name="tel" class="form-control" type="text" required maxlength="11"></td>
  </tr>
  <tr>
    <td>E-Mail</td>
    <td><input placeholder="E-Mailiniz" name="mail" class="form-control" type="text" required></td>
  </tr>
  <tr>
    <td>Adres</td>
    <td><textarea placeholder="Adres" required name="adres" cols="40" rows="3"></textarea></td>
  </tr>
  <tr>
    <td>Şifre</td>
  ...
  <tr>
    <td>Şifre Tekrar</td>
    <td><input placeholder="Şifreniz" name="sifretekrar" id="kullanimkosullari" class="form-control" type="password" required></td>
  </tr>
  <tr>
    <td align="right"><input type="checkbox" class="form-check-input" onChange="kullanimkosullari()"></td>
    <td>Kullanım koşullarını kabul ediyorum.</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><button name="submit" type="submit" class="btn btn-dark" id="submit">Üye Ol</button></td>
  </tr>
