...
<body>
    ...
    <div class="col-md-4 col-lg-4 col-sm-4"><!-- InstanceBeginEditable name="session" --><div class="dropdown">
...
<div class="container">
<div class="row">
 <!-- InstanceBeginEditable name="head" --><div class="col-xl-2 col-md-2 col-sm-2 col-lg-2 col-xl-2"></div>
 <div class="col-xl-8 col-md-8 col-sm-8 col-lg-8 col-xl-8"><br>
 <table width="531">
 <tr>
 <td colspan="6" align="center"><h4>Sepetim</h4></td>
 </tr>
 <tr>
 <td width="143">Ürün Fotoğrafı  </td>
 <td width="78">Ürün Adı   </td>
 <td width="90">Beden   </td>
 <td width="90">Adet   </td>
 <td width="46">Fiyat  </td>
 <td width="87"> </td>
 </tr>
 <?php include("Connections/baglan.php");
 $musteriid=$id;
 $sorgu=mysql_query("SELECT urun.urun_ad, urun.urun_foto1, urun.urun_fiyat, sepet.adet, sepet.id, beden.beden from sepet INNER JOIN urun ON sepet.urun_id=urun.urun_id INNER JOIN beden ON sepet.beden_id=beden.id WHERE sepet.musteri_id=$musteriid"); 
 $toplam=0; 
 while($yazz=mysql_fetch_array($sorgu))
	{ 
	?>
    <form action="sepettensil.php?id=<?php echo $yazz['id']; ?>" method="POST" name="sepettensil">
    <tr>
  	<td><img src="adminpanel/<?php echo $yazz["urun_foto1"]; ?>" style="width:50%"></td>
    <td width="78"><?php echo $yazz['urun_ad']; ?></td>
    <td width="90"><?php echo $yazz['beden']; ?></td>
    <td width="90"><?php echo $yazz['adet']; ?></td>
    <td width="46"><?php echo $yazz['adet']*$yazz['urun_fiyat']; $toplam+=$yazz['adet']*$yazz['urun_fiyat'];?></td>
    <td><button name="sepettensilbuton" type="submit" class="btn btn-dark" id="submit">Sil</button></td>
    <td></td>
    <td></td>
  </tr>
   </form>
 ...
 <div class="col-xl-4 col-md-4 col-sm-4 col-lg-4 col-xl-4"></div>
 <div class="col-xl-4 col-md-4 col-sm-4 col-lg-4 col-xl-4" align="left"><h3><b>Toplam: <?php $_SESSION['toplam']=$toplam; echo $toplam;?></b></h3><a href="adresekle.php?id=<?php echo $id; ?>" class="btn btn-dark" role="button">Alışverişi Tamamla</a></div>
 </div><!--row alışverişi tamamla-->
 </div><!--row-->
