...
<div class="container">
<div class="row">
 <!-- InstanceBeginEditable name="head" --><div class="col-xl-4 col-md-4 col-sm-4 col-lg-4 col-xl-4"></div>
 ...
 <?php
	...
	{
	?> 
    <form action="adresonayla.php?id=<?php echo $yaz["id"]; ?>" method="post">
  <table width="450" align="center">
  <tr>
    <td colspan="2" align="center"><h4>Adres Güncelle</h4></td>
  </tr>
  <tr>
    <td align="left">Ad</td>
  ...
  <tr>
    ...
    <td align="left"><textarea placeholder="Adres" required name="adres" rows="5" cols="40"><?php echo $yaz['adres'];?></textarea></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
